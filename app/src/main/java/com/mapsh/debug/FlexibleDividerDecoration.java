...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected FlexibleDividerDecoration(FlexibleDividerDecoration.Builder builder) {
        if (builder.mPaintProvider != null) {
            ...
            if (builder.mDrawableProvider == null) {
                ...
                a.recycle();
                mDrawableProvider = new FlexibleDividerDecoration.DrawableProvider() {
                    @Override
    ...
    private void setSizeProvider(FlexibleDividerDecoration.Builder builder) {
        mSizeProvider = builder.mSizeProvider;
        if (mSizeProvider == null) {
            mSizeProvider = new FlexibleDividerDecoration.SizeProvider() {
                @Override
    ...
    public static class Builder<T extends FlexibleDividerDecoration.Builder> {

        private Context mContext;
        protected Resources mResources;
        private FlexibleDividerDecoration.PaintProvider mPaintProvider;
        private FlexibleDividerDecoration.ColorProvider mColorProvider;
        private FlexibleDividerDecoration.DrawableProvider mDrawableProvider;
        private FlexibleDividerDecoration.SizeProvider mSizeProvider;
        private FlexibleDividerDecoration.VisibilityProvider mVisibilityProvider = new FlexibleDividerDecoration.VisibilityProvider() {
            @Override
        ...
        public T paint(final Paint paint) {
            return paintProvider(new FlexibleDividerDecoration.PaintProvider() {
                @Override
        ...
        public T paintProvider(FlexibleDividerDecoration.PaintProvider provider) {
            mPaintProvider = provider;
            return (T) this;
        }

        public T color(final int color) {
            return colorProvider(new FlexibleDividerDecoration.ColorProvider() {
                @Override
        ...
        public T colorProvider(FlexibleDividerDecoration.ColorProvider provider) {
        ...
        public T drawable(final Drawable drawable) {
            return drawableProvider(new FlexibleDividerDecoration.DrawableProvider() {
                @Override
                public Drawable drawableProvider(int position, RecyclerView parent) {
                    return drawable;
                }
        ...
        public T drawableProvider(FlexibleDividerDecoration.DrawableProvider provider) {
            mDrawableProvider = provider;
            return (T) this;
        }

        public T size(final int size) {
            return sizeProvider(new FlexibleDividerDecoration.SizeProvider() {
                @Override
                public int dividerSize(int position, RecyclerView parent) {
                    return size;
                }
        ...
        public T sizeProvider(FlexibleDividerDecoration.SizeProvider provider) {
            mSizeProvider = provider;
            return (T) this;
        }

        public T visibilityProvider(FlexibleDividerDecoration.VisibilityProvider provider) {
